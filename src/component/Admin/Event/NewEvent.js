...
import { clearError, createEvent } from "../../../redux/actions/eventActions";
import { CREATE_EVENT_RESET } from "../../../redux/constants/eventConstant";
...
const NewProduct = () => {
    ...
    const createEventSubmitHandler = (e) => {
        ...
        dispatch(createEvent(myForm, lang));
    };
                ...
                <div className="newProductContainer">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="Arabic Event title"
                                required
                                value={title_ar}
                        ...
                        <div>
                            <DescriptionIcon />
                            <textarea
                                placeholder="Arabic Event Description"
